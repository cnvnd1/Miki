  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <div class="top-nav notification-row">                
				...
				</span> <span id="mikiUserId" class="username">${userId}</span> <b
					class="caret"></b>
                        </a>
	...
	userid : <input type="text" name="userid" id = "inputUserid"> Date : <input type="text" name="date" id = "inputDate"> 
              ...
              <div class="panel panel-default">
				...
				<div class="panel-body progress-panel">
					<div class="row">
						...
						<div class="col-lg-4">
							<span class="profile-ava pull-right"> </span>
						</div>
					</div>
				</div>
		...
		<div class="row">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <div class="pull-left">포스트 쓰기</div>
                  <div class="widget-icons pull-right">
                    <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> 
                    <a href="#" class="wclose"><i class="fa fa-times"></i></a>
                  </div>  
                ...
                <div class="panel-body">
                  <div class="padd">
                      ...
                      <div class="form quick-post">
								...
								<form class="form-horizontal" action="postWrite" method="post">
									<!-- Title -->
									<div class="form-group">
									...
									<!-- Cateogry -->
									<div class="form-group">
										<label class="control-label col-lg-2">포스트 종류</label>
										<div class="col-lg-10">
											<select class="form-control" name="postType">
												<option value="base">- 종류를 선택하세요 -</option>
									...
									<!-- Tags -->
									<div class="form-group">
										<label class="control-label col-lg-2" for="tags">태그</label>
										<div class="col-lg-10">
